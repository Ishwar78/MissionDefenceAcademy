  ...
  const courses = [
    {
      ...
      description:
        "Comprehensive physical training for Army recruitment with expert guidance and proven methods.",
      image: "🏃‍♂️",
    },
    {
      title: "Army Medical Test",
      description:
        "Medical examination preparation with detailed guidance on fitness standards and requirements.",
      image: "🏥",
    },
    {
      title: "Army Written Test",
      description:
        "Complete written test preparation covering all subjects with practice tests and study materials.",
      image: "📝",
    },
    {
      title: "NDA",
    ...
    },
    {
      title: "Navy AA/SSR",
      description:
        "Indian Navy Artificer Apprentice and Senior Secondary Recruit training programs.",
      image: "⚓",
    },
    {
      title: "Air Force X & Y Group",
      description:
        "Air Force technical and non-technical group preparation with specialized coaching.",
      image: "✈️",
    },
    {
      title: "Soldier/General Duty (GD)",
      description:
        "General Duty soldier recruitment preparation with physical and written test training.",
      image: "👮‍♂️",
    },
    {
      title: "Army Clerk",
      description:
        "Army clerk position preparation with typing, computer skills, and written test training.",
      image: "💻",
    },
    {
      title: "Army Soldier Technical",
      description:
        "Technical soldier positions preparation with specialized technical knowledge and skills.",
      image: "🔧",
    },
  ];
    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-red-50 p-8 rounded-lg">
              ...
              <p className="text-gray-700 leading-relaxed">
                Strategic teaching approach for competitive success, building
                future officers with excellence and dedication to serve the
                nation with honor and integrity.
              </p>
            </div>
            ...
            <div className="bg-blue-50 p-8 rounded-lg">
              ...
              <p className="text-gray-700 leading-relaxed">
                Character building, endurance development, and fostering the
                spirit of national service among our students to create
                disciplined and capable defence personnel.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                Welcome to Mission Defence Academy, where we transform dreams
                into reality. With over a decade of experience in training
                defence aspirants, our academy stands as a beacon of excellence
                in military training.
              </p>
              <p className="text-gray-700 leading-relaxed mb-6">
                Our dedicated faculty, state-of-the-art facilities, and proven
                training methodologies ensure that every student receives
                personalized attention and guidance. We take pride in our 100%
                success rate and the achievements of our students who are now
                serving the nation with pride.
              </p>
              <p className="text-gray-700 leading-relaxed">
                At Mission Defence Academy, we don't just prepare you for tests;
                we prepare you for life as a defence officer. Join us and be
                part of our legacy of excellence.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Comprehensive training programs for all defence services
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {courses.map((course, index) => {
              ...
              const getServiceRoute = (title: string) => {
                ...
                if (title.includes("Air Force"))
                  return "/services/indian-air-force";
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              World-class facilities for comprehensive training
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-red-100">
              What makes us the best choice for defence preparation
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {coreStrengths.map((strength, index) => (
              <div
                key={index}
                className="flex items-center bg-red-700 p-4 rounded-lg"
              >
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Our proud achievers serving the nation
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Stadium Activity Videos
            </h2>
            <p className="text-xl text-gray-600">
              Watch our training sessions and activities
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Mission Defence Academy Training
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Mission Defence Academy Overview
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Glimpses of our academy and training facilities
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
              ...
              <div className="p-4">
                <p className="text-sm font-medium text-gray-900">
                  Rajiv Gandhi Stadium - Main Training Ground
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
              ...
              <div className="p-4">
                <p className="text-sm font-medium text-gray-900">
                  Group Training Session - Physical Fitness
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
              ...
              <div className="p-4">
                <p className="text-sm font-medium text-gray-900">
                  Modern Hostel Facilities - Comfortable Living
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
              ...
              <div className="p-4">
                <p className="text-sm font-medium text-gray-900">
                  Navy Training - Parade Formation
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
              ...
              <div className="p-4">
                <p className="text-sm font-medium text-gray-900">
                  Training Group - Future Officers
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-6 gap-6">
            {popularCourses.map((course, index) => (
              <div
                key={index}
                className="bg-white p-6 rounded-lg text-center border border-gray-200 hover:shadow-lg transition-shadow cursor-pointer"
              >
