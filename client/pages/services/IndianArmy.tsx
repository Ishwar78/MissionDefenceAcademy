  ...
  const trainingPrograms = [
    {
      ...
      description:
        "Comprehensive physical training including running, pull-ups, and endurance exercises.",
      icon: "🏃‍♂️",
    },
    {
      title: "Army Written Test",
      description:
        "Complete preparation for written examination covering all subjects.",
      icon: "📝",
    },
    {
      title: "Army Medical Test",
      description:
        "Medical examination preparation with detailed guidance on fitness standards.",
      icon: "🏥",
    },
    {
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Specialized coaching for Indian Army recruitment with
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-gray-900 mb-6">
                Indian Army Recruitment Training
              </h2>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Our Indian Army training program is designed to prepare aspiring
                soldiers for all aspects of army recruitment. With expert
                trainers and proven methodologies, we ensure comprehensive
                preparation for physical tests, written examinations, and
                interview processes.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed mb-8">
                Join thousands of successful candidates who have achieved their
                dream of serving the nation through our specialized training
                programs at Mission Defence Academy.
              </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Army Training Introduction
            </h2>
            <p className="text-xl text-gray-600">
              Watch our comprehensive army training program overview
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-2">
                Indian Army Training Program Overview
              </h3>
              <p className="text-gray-600">
                Complete introduction to our army recruitment training
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Comprehensive preparation for all army recruitment phases
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-green-100">
              What makes our army training program unique
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {highlights.map((highlight, index) => (
              <div
                key={index}
                className="flex items-center bg-green-700 p-4 rounded-lg"
              >
      ...
      <section className="py-16 bg-gray-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold mb-6">
            Ready to Join the Indian Army?
          </h2>
          <p className="text-xl text-gray-300 mb-8">
            Take the first step towards serving your nation. Join our
            comprehensive army training program today.
          </p>
