  ...
  const trainingPrograms = [
    {
      ...
      description:
        "Technical training for Air Force X Group positions and technical trades.",
      icon: "✈️",
    },
    {
      title: "Air Force Y Group",
      description:
        "Non-technical training for Air Force Y Group administrative positions.",
      icon: "🛩️",
    },
    {
      title: "Aptitude Training",
      description:
        "Comprehensive aptitude test preparation for air force recruitment.",
      icon: "🧠",
    },
    {
      title: "Technical Knowledge",
      description:
        "Aircraft systems, maintenance, and technical knowledge training.",
      icon: "⚙️",
    },
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Air Force X & Y Group preparation with technical and non-technical
              training
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-gray-900 mb-6">
                Indian Air Force Recruitment Training
              </h2>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Our Indian Air Force training program provides comprehensive
                preparation for both X Group (Technical) and Y Group
                (Non-Technical) positions. With expert coaching in aptitude,
                technical knowledge, and interview preparation.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed mb-8">
                Join our specialized air force training program and soar high in
                your career with the Indian Air Force. Our proven methodology
                ensures success in all recruitment phases.
              </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Air Force Training Introduction
            </h2>
            <p className="text-xl text-gray-600">
              Discover our air force training methodology and success stories
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-2">
                Air Force Training Program Overview
              </h3>
              <p className="text-gray-600">
                Complete guide to our air force recruitment preparation and
                training methods.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Specialized preparation for air force recruitment
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">
              Air Force Training Highlights
            </h2>
            <p className="text-xl text-sky-100">
              Excellence in aviation training and preparation
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {highlights.map((highlight, index) => (
              <div
                key={index}
                className="flex items-center bg-sky-700 p-4 rounded-lg"
              >
      ...
      <section className="py-16 bg-gray-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold mb-6">
            Ready to Join the Indian Air Force?
          </h2>
          <p className="text-xl text-gray-300 mb-8">
            Take flight in your career. Join our comprehensive air force
